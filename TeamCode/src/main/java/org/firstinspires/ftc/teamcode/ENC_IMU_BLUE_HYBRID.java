...
@Autonomous(name = "ENC_IMU_BLUE_V2")
public class ENC_IMU_BLUE_HYBRID extends autoBaseV2 {
...
//        goToPositionStrafeLeft(chart.TL, chart.TR, chart.BL, chart.BR, distance2encoderNew(5), -0.3);
        ...
        goToPosition(chart.BR, chart.TL, distance2encoderNew(chart.correction), 0.3, false);
